...
[NodeToolTip("Sends a custom event with a GameObject variable.")]
[NodeAuthor("Detox Studios LLC", "http://www.detoxstudios.com")]
[NodeHelp("http://docs.uscript.net/#3-Working_With_uScript/3.4-Nodes.htm")]

[FriendlyName("Send Custom Event (GameObject)", "Sends a custom event with a GameObject variable.")]
public class uScriptAct_SendCustomEventGameObject : uScriptLogic
{
